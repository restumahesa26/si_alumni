...
@section('title')
    <title>Admin | Detail Diskusi</title>
@endsection
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    ...
                    <p>Menampilkan Detail Diskusi beserta Tanya Jawab</p>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @forelse ($tanya_jawabs as $tanya_jawab)
                            <div class="mb-2
                            @if ($tanya_jawab->user_id == $tanya_jawab->diskusis->user_id)
                                text-right
                            @else
                                text-left
                            @endif">
                        ...
                        @endforelse
                        <form action="{{ route('tanya_jawab_diskusi', $item->id) }}" method="POST" class="mt-5">
                            @csrf
...
{{-- <x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-8 py-8">
                ...
                <p class="font-light text-sm mt-2">
                    Dibuat oleh <span class="font-bold">{{ $nama }}</span> pada tanggal {{ \Carbon\Carbon::parse($item->created_at)->format('d F Y') }}
                </p>
    ...
    <div class="pb-12">
        @forelse ($tanya_jawabs as $tanya_jawab)
        <div class="max-w-7xl mx-auto px-10 mt-4 @if ($tanya_jawab->user_id == $tanya_jawab->diskusis->user_id)
            text-right
        @endif">
        ...
        <div class="max-w-7xl mx-auto px-10 mt-4">
            <div class="bg-white overflow-hidden px-4 py-6 rounded">
                <h3 class="text-center">Belum Ada Tanya Jawab</h3>
            </div>
        </div>
        @endforelse
    </div>
    ...
    <div class="pb-10">
        <div class="max-w-7xl mx-auto px-10">
            <div class="bg-white overflow-hidden px-4 py-2 rounded">
                <form action="{{ route('tanya_jawab_diskusi', $item->id) }}" method="POST">
                    @csrf
